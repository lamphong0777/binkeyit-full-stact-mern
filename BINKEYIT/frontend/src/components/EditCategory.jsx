...
const EditCategory = ({close, fetchData, data: CategoryData, currentPage}) => {
                ...
                <form className='my-3 grid gap-2' onSubmit={handleSubmit}>
                    ...
                    <div className='grid gap-1'>
                        ...
                        <div className='flex gap-4 flex-col lg:flex-row items-center'>
                            <div
                                className='border bg-blue-50 h-36 w-full lg:w-36 flex items-center justify-center rounded'>
                                {
                                    data.image ? (
                                        <img
                                            alt='category'
                        ...
                        `}>
                                ...
                                <input disabled={!data.name} onChange={handleUploadCategoryImage} type='file'
                                       id='uploadCategoryImage' className='hidden'/>
                            </label>
